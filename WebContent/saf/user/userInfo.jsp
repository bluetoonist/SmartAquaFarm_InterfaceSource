                            ...
                            <div class="card-body">                            
	                            	<input type="hidden" name="flag">	                                    
	                                    <div class="form-row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 row-cols-xl-2">
	                                        ...
	                                        <div class="col">
	                                            ...
	                                            <input class="form-control" type="text" value="<%=dto.getUserName() %>" name="username"></div>
	                                        </div>
	                                        ...
	                                        <div class="col">
	                                            ...
	                                            <input class="form-control" type="text" value="<%= dto.getUserTel() %>" name="usertel"></div>
	                                        </div>
                        			...
                        			<!-- End: 구분선 -->
	                         		...
	                         		<form name="userPW">
                                        ...
                                        <div class="col-xl-12 text-center text-sm-center text-md-center text-lg-center text-xl-center mt-1">
